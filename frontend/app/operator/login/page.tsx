...
import { useLoginOperator, useLogoutOperator, useOperator } from "@/hooks/use-operator";
...
export default function OperatorLoginPage() {
  ...
  const { data: operator, isPending: isOperatorPending } = useOperator();
      ...
      <div className="flex flex-1 items-center justify-center p-4">
        <Card className="w-full max-w-sm">
          <CardHeader>
            ...
            <CardDescription>
              {operator.name}（{operator.email}／{operator.role}）としてログインしています。
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
